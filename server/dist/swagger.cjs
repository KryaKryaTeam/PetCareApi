        ...
        schemas: {
            ...
            AnimalType: {
                ...
                properties: {
                    ...
                    icon: { type: "string", format: "uri", example: "%backend%/images/baseicon.png" },
                    breeds: { type: "array", items: { type: "string" }, example: ["first breed", "second breed"] },
                },
                required: ["name"],
            },
            ...
            Animal: {
                ...
                properties: {
                    ...
                    documents: { type: "array", items: { type: "string", description: "ObjectId" } },
                    injections: { type: "array", items: { type: "string", description: "ObjectId" } },
                    ...
                    avatar: { type: "string", format: "uri", example: "%backend%/images/baseicon.png" },
                    notes: { type: "array", items: { type: "string", description: "ObjectId" } },
            ...
            Document: {
                ...
                properties: {
                    ...
                    fileUrl: { type: "string", format: "uri", example: "%backend%/images/baseicon.png" },
            ...
            User: {
                ...
                properties: {
                    ...
                    googleRefreshToken: { type: "string", example: "google refresh token" },
                    animals: { type: "array", items: { type: "string", description: "ObjectId" } },
                    avatar: { type: "string", format: "uri", example: "%backend%/images/baseicon.png" },
                    sessions: {
                        type: "array",
                        items: {
