...
exports.PlannedInjection = exports.Injection.discriminator("planned", new mongoose_1.default.Schema({
    breed: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "Breed", required: true },
...
exports.InjectionRecord = exports.Injection.discriminator("record", new mongoose_1.default.Schema({
    animal: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "Animal", required: true },
    injectionRef: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "Injection", required: true },
